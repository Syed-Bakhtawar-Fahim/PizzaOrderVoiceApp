...
// Boiler Plate Code
app.get("/", (req, res) => {
    res.send("This is a server of Pizza Ordering App developed by Syed Bakhtawar Fahim");
})
...
app.listen(PORT, () => {
    console.log(`The server of Pizza Ordering App developed by Syed Bakhtawar Fahim is running at ${PORT}`);
});